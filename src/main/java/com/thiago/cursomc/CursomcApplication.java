...
public class CursomcApplication implements CommandLineRunner {
	...
	@Autowired
	private ProdutoRepository produtoRepositry;
	...
	public void run(String... args) throws Exception {
		...
		categoriaRepositry.saveAll(Arrays.asList(cat1,cat2,cat3,cat4,cat5,cat6,cat7));
		produtoRepositry.saveAll(Arrays.asList(p1,p2,p3));
